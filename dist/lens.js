...
function initLens(){
 ...
 const button=document.createElement('button');button.id='lensToggle';button.className='quiet';button.dataset.fixedLanguage='';button.dataset.lensToggle='';button.lang='fr';button.setAttribute('aria-pressed','false');button.textContent='🔎 Loupe FR → DE';document.querySelector('.header-actions').prepend(button);
